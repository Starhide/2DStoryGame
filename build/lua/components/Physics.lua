...
function Physics:update(dt) 
    trans = self.entity:get("Transform")
...
function Physics:getGlobalVelocity()
    if self.entity.parent and self.entity.parent:get("Physics") then
        return self.entity.parent:get("Physics"):getGlobalVelocity() + self.velocity
    end
...
function Physics:getGlobalAcceleration()
    if self.entity.parent and self.entity.parent:get("Physics") then
        return self.entity.parent:get("Physics"):getGlobalAcceleration() + self.acceleration
    end
...
function Physics:getGlobalAngVel()
    if self.entity.parent and self.entity.parent:get("Physics") then
        return self.entity.parent:get("Physics"):getGlobalAngVel() + self.angVelocity
    end
...
function Physics:getGlobalAngAccel()
    if self.entity.parent and self.entity.parent:get("Physics") then
        return self.entity.parent:get("Physics"):getGlobalAngAccel() + self.angAcceleration
    end
